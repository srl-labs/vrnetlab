...
class VJUNOSEVOLVED_vm(vrnetlab.VM):
    ...
    def startup_config(self):
        ...
        # if startup cfg file is found
            ...
            # Append startup cfg to initial configuration. Strip any address the
            # appended startup config sets on the mgmt interface so re0:mgmt-0
